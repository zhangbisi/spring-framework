...
import com.zhuri.annotation.upms.bean.condition.ComputerUser;
import com.zhuri.annotation.upms.bean.condition.LinuxCondition;
import com.zhuri.annotation.upms.bean.condition.WindCondition;
 ...
 */
@Configuration
@ComponentScan(value = "com.zhuri.annotation.upms.bean.condition") //自定义扫描规则
