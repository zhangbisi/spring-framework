package com.wisdom.annotation.upms.dao.model;
...
public class UpmsLog implements Serializable {
	...
	public UpmsLog(Integer logId, String description, String username, Long startTime, Integer spendTime, String basePath,
				   String uri, String url, String method, String userAgent, String ip, String permissions, String parameter, String result) {
		this.logId = logId;
